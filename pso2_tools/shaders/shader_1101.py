...
class Shader1101(builder.ShaderBuilder):
    ...
    def build(self, context):
        ...
        output = tree.add_node(bpy.types.ShaderNodeOutputMaterial, (18, 6))

        shader_group = tree.add_node(ShaderNodePso2Ngs, (12, 6))  # type: ignore
        ...
        # Diffuse
        diffuse = tree.add_node(bpy.types.ShaderNodeTexImage, (0, 12), name="Diffuse")
